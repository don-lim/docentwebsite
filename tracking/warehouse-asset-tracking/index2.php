			...
			<div class="mar_t_20">
				<div class="col-lg-4 col-md-6 col-sm-12 wow fadeInLeft delay-02s">
					<div class="link_preview">
						<div class="l_p_item">
							<div class="l_p_img"><img src="/img/img-warehouse-asset-tracking-1.jpg" width="80" height="80"></div>
							<div class="l_p_meta">
				...
				<div class="col-lg-4 col-md-6 col-sm-12 wow fadeInLeft delay-02s">
					<div class="link_preview">
						<div class="l_p_item">
							<div class="l_p_img"><img src="/img/img-warehouse-asset-tracking-2.jpg" width="80" height="80"></div>
							<div class="l_p_meta">
